		...
		/***/ function(module, exports, __webpack_require__) {
			...
			var SelectionRendererFactory = (function () {
				...
				SelectionRendererFactory.prototype.createSelectionCheckbox = function (rowNode, rowIndex, addRenderedRowEventListener) {
					...
					eCheckbox.name = "name";
					eCheckbox.id = "metatron-" + (new Date()).getTime() + Math.floor((Math.random() * 1000) + 1);
					eCheckbox.className = 'mu-checkbox';
			...
			var RenderedCell = (function () {
				...
				RenderedCell.prototype.createParentOfValue = function () {
					if (this.checkboxSelection) {
						...
						this.eLabel.setAttribute("for",this.eCheckbox.id);
						this.eCellWrapper.appendChild(this.eLabel);
		...
		/***/ function(module, exports, __webpack_require__) {
			...
			var GridPanel = (function () {
				...
				GridPanel.prototype.createLoadingOverlayTemplate = function () {
					...
					var localeTextFunc = this.gridOptionsWrapper.getLocaleTextFunc();
					var templateLocalised = templateNotLocalised.replace('[LOADING...]', localeTextFunc('loadingOoo', ''));
				...
				GridPanel.prototype.createNoRowsOverlayTemplate = function () {
					...
					var localeTextFunc = this.gridOptionsWrapper.getLocaleTextFunc();
					var templateLocalised = templateNotLocalised.replace('[NO_ROWS_TO_SHOW]', localeTextFunc('noRowsToShow', ''));
					return templateLocalised;
				};
