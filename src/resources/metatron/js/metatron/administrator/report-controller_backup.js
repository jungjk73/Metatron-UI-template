define(["app", "moment"], function(app, moment) {
  app.controller("ReportCtrl", ["$rootScope", "$scope", "$interval", "$timeout", "$filter", "$http", "$q", "DataService", "ConfigManager", "GridRenderer", "ngDialog", 'CommonUtil',
    function($rootScope, $scope, $interval, $timeout, $filter, $http, $q, DataService, ConfigManager, GridRenderer, ngDialog, CommonUtil) {
      ...
      function addEventListener() {
        unbind = [
          $scope.$on(ConfigManager.getEvent('GRID_SETTING_BTN_EVENT'), onReportMetricConfig),
