define(['app'], function(app) {
	app.directive('checklistModel', ['$parse', '$compile', function($parse, $compile) {
		...
		// add
		function add(arr, item, comparator, multiSelect) {
			arr = (multiSelect && angular.isArray(arr)) ? arr : [];
		...
		function postLinkFn(scope, elem, attrs) {
		    ...
		    var multiSelect = (attrs.multiSelect == null || attrs.multiSelect == 'false') ? false:true;
			...
			function setValueInChecklistModel(value, checked) {
				...
				if (angular.isFunction(setter)) {
					if (checked === true) {
						setter(scope.$parent, add(current, value, comparator, multiSelect));
					} else {
